        ...
        <div className="grid gap-6 xl:grid-cols-[1.05fr,0.95fr]">
          ...
          <Card className="space-y-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <label className={adminLabelClassName}><span className={adminLabelTextClassName}>Check-in time</span><input name="checkInTime" className={adminInputClassName} value={form.checkInTime} onChange={(event) => setForm((current) => ({ ...current, checkInTime: event.target.value }))} /></label>
              <label className={adminLabelClassName}><span className={adminLabelTextClassName}>Check-out time</span><input name="checkOutTime" className={adminInputClassName} value={form.checkOutTime} onChange={(event) => setForm((current) => ({ ...current, checkOutTime: event.target.value }))} /></label>
